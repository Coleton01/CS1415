...
correlating to the input chosen. The user will be able to press ctrl+C to close the program or allow the program
to continue running. The choice was enabled by the use of a while loop with != condition. 

"""

#input for variable
choice=""
while choice != int(9):                      #modification for part 2 of assignment, using complex conditional statements
    choice=int(input("please enter a number, 1-5 to choose a program or Ctrl+C to quit: "))



# decision tree for input

    if choice ==1: #program for user input "1"
    ...
    elif choice==2: #program for user input "2"
    ...
    elif choice ==3: #program for user input "3"
    ...
    elif choice == 4: #program for user input "4"
     ...
     #outputs               
    ...
    elif choice ==5: #program for user input "5"
        from random import randint
        ...
        if answer == "Y" or answer=="y":
             print("This assignment is worth",randint(90,100),"percent") #random number generated between 90-100
